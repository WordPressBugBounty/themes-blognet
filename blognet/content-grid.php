...
<div id="grid" class="row" >
    ...
    <div id="post-<?php the_ID(); ?>" <?php if($blognet_content_layout == "grid-fullwidth") { echo post_class('col-md-4'); } else { echo post_class('col-md-6'); } ?>>
            ...
            <div class="bs-blog-post"> 
                ...
                <article class="small">
                    ...
                    <?php blogarise_post_meta(); ?>
                            <?php $blognet_blog_content = get_theme_mod('blogarise_blog_content', 'excerpt'); 
                            if($blognet_blog_content == 'excerpt')
                            {
                            ?>
